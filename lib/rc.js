...
function RC(dir) {
    ...
    return {
        ...
        project: function (identifier) {
            if(identifier) {
                ...
                if (self.manifest.projects.length === 1) {
                    ...
                    throw new Error('The RC at ' + this.path + ' contains multiple projects. You must specify a project identifier in rc.project(identifier)');
                }
            }
            return null;
        },
        ...
        /**
         * Returns the resource container manifest information.
         *
         * @returns {{}}
         */
        get manifest() {
