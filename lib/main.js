...
function createContainer(dir, manifest) {
    return new Promise(function(resolve, reject) {
        ...
        // TRICKY: concatenating 'undefined' will produce a trailing ,
        if(!manifest.projects || !(manifest.projects instanceof Array)) manifest.projects = [];
        ...
        let opts = {
            ...
            projects: defaults.projects.concat(manifest.projects)
        };
        sortKeys(opts, {deep: true});
